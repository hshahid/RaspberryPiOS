//code to interact with the keyboard
.section .data

//address of keyboard the code reads from
.align 2
KeyboardAddress:
	.int 0
	
//scan codes that were down before the current set
KeyboardOldDown:
	.rept 6
	.hword 0
	.endr
...
//ascii representations of the first 104 scan codes
//ignore special keys
.align 3
KeysNormal:
...
//update data when the keyboard is pressed and released
...
//return r0 = 0 in r1 if key was not pressed before the current scan
.globl KeyWasDown
KeyWasDown:
	ldr r1,=KeyboardOldDown
	mov r2,#0
...
//return the last ascii character typed on the keyboard
